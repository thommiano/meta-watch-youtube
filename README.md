...
Authors: Adam, Jeff, and Thom

## Overview

Analyze your YouTube watching patterns.
...
On MacOS, you can install node.js with the following:

```bash
brew install node
```

Next, you'll want to install the necessary node modules. In the root of this repo run:

```bash
npm install
```

Once this is install you can launch the app with:
...
You'll need to have `meta-watch/src/data/history.json'
